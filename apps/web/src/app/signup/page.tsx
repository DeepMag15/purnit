...
export default function SignupPage() {
  ...
  // added "Finance". Manufacturing Domain, Phase A added "Manufacturing" —
  // done in this same commit this time, not a follow-up hotfix (Education's
  // own launch missed it once).
  const [industry, setIndustry] = useState<"IT" | "Healthcare" | "Education" | "Finance" | "Manufacturing">("IT");
    ...
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-bg px-4">
      ...
      <div className="relative z-10 w-full max-w-sm rounded-xl border border-border bg-surface p-7 shadow-sm">
        ...
        <form onSubmit={handleSubmit} className="mt-6 flex flex-col gap-3">
          ...
          <Select
            value={industry}
            onChange={(e) => setIndustry(e.target.value as "IT" | "Healthcare" | "Education" | "Finance" | "Manufacturing")}
            aria-label="Industry"
          >
