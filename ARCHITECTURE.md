...
| `dashboard_layouts` | role- or user-level Analytics dashboard section/widget ordering. **As built (Analytics & Insights, Phase D) — see §8.2 for the full record.** |
